...
I am a member of the **Oxford Secure Computer Architecture Research (OSCAR)** group as well as a contributor to the **Computing infrastructure Group**. My PhD (Oxford calls them DPhils) is fully funded by the Advanced Research and Invention Agency (ARIA) as part of Oxford-based Project GLASS which aims to design the next generation of AI systems from physical layer design to the Applicaiton layer. (Read here for more: [https://eng.ox.ac.uk/computing/glass](https://eng.ox.ac.uk/computing/glass))
